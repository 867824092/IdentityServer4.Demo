        ...
        public static IEnumerable<Client> GetClients()
        {
            return new[]
            {
                new Client
                {
                    ...
                    RedirectUris={"http://localhost:7002/AuthenticationSuccess" },//可以多个，根据请求来的转发
